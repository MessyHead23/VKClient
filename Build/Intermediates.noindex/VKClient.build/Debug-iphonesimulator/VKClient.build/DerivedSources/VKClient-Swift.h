...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="VKClient",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8VKClient11AppDelegate")
...
SWIFT_CLASS("_TtC8VKClient19LoginViewController")
...
- (void)keyboardWasShownWithNotification:(NSNotification * _Nonnull)notification;
- (void)keyboardWillHiddenWithNotification:(NSNotification * _Nonnull)notification;
